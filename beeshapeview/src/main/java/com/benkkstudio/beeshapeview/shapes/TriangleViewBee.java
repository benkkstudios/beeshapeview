...
public class TriangleViewBee extends BeeShapeOfView {
    private float percentBottom = 0.5f;
    private float percentLeft = 0f;
    private float percentRight = 0f;

    public TriangleViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public TriangleViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TriangleViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
