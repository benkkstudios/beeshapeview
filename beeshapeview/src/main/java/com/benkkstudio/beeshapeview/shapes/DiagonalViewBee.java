...
public class DiagonalViewBee extends BeeShapeOfView {
    ...
    public DiagonalViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public DiagonalViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DiagonalViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
