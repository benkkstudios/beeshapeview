...
public class StarViewBee extends BeeShapeOfView {

    private int noOfPoints = 5;

    public StarViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public StarViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public StarViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
