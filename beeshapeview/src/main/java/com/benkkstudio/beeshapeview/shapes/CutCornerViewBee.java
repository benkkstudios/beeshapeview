...
public class CutCornerViewBee extends BeeShapeOfView {
    ...
    public CutCornerViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public CutCornerViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CutCornerViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
