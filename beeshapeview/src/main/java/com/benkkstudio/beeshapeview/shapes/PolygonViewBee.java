...
public class PolygonViewBee extends BeeShapeOfView {
    private int numberOfSides = 4;

    public PolygonViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public PolygonViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PolygonViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
