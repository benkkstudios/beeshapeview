...
public class BubbleViewBee extends BeeShapeOfView {
    ...
    public BubbleViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public BubbleViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BubbleViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
