...
public class RoundRectViewBee extends BeeShapeOfView {
    ...
    public RoundRectViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public RoundRectViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundRectViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
