...
public class CircleViewBee extends BeeShapeOfView {
    ...
    public CircleViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public CircleViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CircleViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
