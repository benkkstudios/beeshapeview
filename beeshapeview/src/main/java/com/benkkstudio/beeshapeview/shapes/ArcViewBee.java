...
public class ArcViewBee extends BeeShapeOfView {
    ...
    public ArcViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public ArcViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ArcViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
