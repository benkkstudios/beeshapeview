package com.benkkstudio.beeshapeview.shapes;
...
import com.benkkstudio.beeshapeview.R;
import com.benkkstudio.beeshapeview.BeeShapeOfView;
import com.benkkstudio.beeshapeview.manager.ClipPathManager;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

public class DottedEdgesCutCornerViewBee extends BeeShapeOfView {
    ...
    public DottedEdgesCutCornerViewBee(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public DottedEdgesCutCornerViewBee(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DottedEdgesCutCornerViewBee(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
