package com.benkkstudio.beeshapeview;
...
import com.benkkstudio.beeshapeview.manager.ClipManager;
import com.benkkstudio.beeshapeview.manager.ClipPathManager;

public class BeeShapeOfView extends FrameLayout {
    ...
    public BeeShapeOfView(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public BeeShapeOfView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public BeeShapeOfView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
